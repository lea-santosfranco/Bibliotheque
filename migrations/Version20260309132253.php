 ...
 */
final class Version20260309132253 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE book CHANGE resume resume VARCHAR(1500) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE book CHANGE resume resume VARCHAR(255) DEFAULT NULL');
